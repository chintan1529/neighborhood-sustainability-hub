...
export const NAV_ITEMS = {
  ...
  recycler: [
    { label: "Dashboard", href: "/recycler", icon: "LayoutDashboard" },
    { label: "Marketplace", href: "/recycler/marketplace", icon: "Store" },
    { label: "My Offers", href: "/recycler/offers", icon: "Tag" },
    { label: "Pickups", href: "/recycler/pickups", icon: "Truck" },
    { label: "Transactions", href: "/recycler/transactions", icon: "Receipt" },
    { label: "Analytics", href: "/recycler/analytics", icon: "BarChart3" },
    {
      label: "Verification",
      href: "/recycler/verification",
      icon: "ShieldCheck",
    },
    { label: "Messages", href: "/recycler/messages", icon: "MessageSquare" },
    { label: "Waste Guide", href: "/info", icon: "BookOpen" },
