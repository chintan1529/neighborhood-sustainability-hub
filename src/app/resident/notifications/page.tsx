...
const TYPE_LABELS: Record<NotificationType, { label: string; icon: string; color: string }> = {
    report_status: { label: 'Report Updates', icon: '📋', color: 'bg-blue-100 text-blue-700' },
    message: { label: 'Messages', icon: '💬', color: 'bg-green-100 text-green-700' },
    workshop: { label: 'Workshops', icon: '📅', color: 'bg-purple-100 text-purple-700' },
    challenge: { label: 'Challenges', icon: '🏆', color: 'bg-orange-100 text-orange-700' },
    points: { label: 'Points', icon: '⭐', color: 'bg-yellow-100 text-yellow-700' },
    badge: { label: 'Badges', icon: '🏅', color: 'bg-amber-100 text-amber-700' },
    system: { label: 'System', icon: '⚙️', color: 'bg-gray-100 text-gray-700' },
    new_offer: { label: 'New Offer', icon: '🔔', color: 'bg-blue-100 text-blue-700' },
    offer_accepted: { label: 'Offer Accepted', icon: '✅', color: 'bg-green-100 text-green-700' },
    pickup_scheduled: { label: 'Pickup Scheduled', icon: '📅', color: 'bg-purple-100 text-purple-700' },
    transaction_completed: { label: 'Transaction Completed', icon: '✅', color: 'bg-green-100 text-green-700' },
};
...
function NotificationCard({ notification }: { notification: Notification }) {
    ...
    return (
        <Card className={`transition-colors ${!notification.is_read ? 'border-primary/50 bg-primary/5' : ''}`}>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2">
                            <div>
                                <Badge variant="secondary" className={`text-xs mb-2 ${typeInfo.color}`}>
                                    {typeInfo.label}
                                </Badge>
