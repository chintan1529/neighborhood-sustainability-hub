                ...
                <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                    <div className="space-y-3">
                        ...
                        <p className="text-muted-foreground text-base max-w-md leading-relaxed">
                            Here&apos;s what&apos;s happening in your neighborhood today. Keep making an impact!
                        </p>
                    </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {quickActions.map((action, i) => {
                    ...
                    return (
                        ...
                        >
                            <div className={`w-11 h-11 rounded-xl bg-gradient-to-br ${action.gradient} flex items-center justify-center mb-3.5 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
