      ...
      {complaints.length === 0 ? (
        <Card>
          <CardContent className="text-center py-12">
            ...
            <p className="text-muted-foreground">
              No complaints yet. Everything running smoothly!
            </p>
          </CardContent>
        </Card>
      ) : (
        <div className="space-y-3">
          {complaints.map((complaint) => {
            ...
            const pri =
              PRIORITY_LABELS[complaint.priority] || PRIORITY_LABELS[2];
                    ...
                    <div className="flex items-start gap-3 flex-1 min-w-0">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <Badge
                            variant="secondary"
                            className={`text-[10px] ${st.color} border-none`}
                          >
                            <StatusIcon className="h-3 w-3 mr-1" />
                            {st.label}
                          </Badge>
                          <span
                            className={`text-[10px] font-medium ${pri.color}`}
                          >
                            {pri.label}
                          </span>
                        </div>
