...
export function AcceptOfferButton({ offerId, price, businessName, isTopOffer }: AcceptOfferButtonProps) {
    ...
    return (
        ...
        >
            {isPending || isAccepting ? (
                ...
                <>
                    {isTopOffer ? <Award className="mr-2 h-4 w-4" /> : <CheckCircle2 className="mr-2 h-4 w-4" />}
                    Accept Offer @ ₹{price}
                </>
            )}
        </Button>
