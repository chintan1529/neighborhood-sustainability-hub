...
import { ArrowLeft, Mail, Smartphone, BellRing, FileText, MessageSquare, Calendar, Trophy, Award, Settings as SettingsIcon } from 'lucide-react';
                    ...
                    <CardContent className="space-y-4">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <Label htmlFor="report_updates" className="font-medium">Report Updates</Label>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <Label htmlFor="workshops" className="font-medium">Workshops & Events</Label>
                                    <p className="text-sm text-muted-foreground">Upcoming workshops and reminders</p>
                                </div>
                            </div>
                            <Switch
                                id="workshops"
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">New challenges and progress updates</p>
                                </div>
                            </div>
                            <Switch
                                id="challenges"
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <Label htmlFor="points_updates" className="font-medium">Points & Rewards</Label>
                                    <p className="text-sm text-muted-foreground">Points earned and rewards</p>
                                </div>
                            </div>
                            <Switch
                                id="points_updates"
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <Label htmlFor="badge_earned" className="font-medium">Badges</Label>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <Label htmlFor="system_updates" className="font-medium">System Updates</Label>
