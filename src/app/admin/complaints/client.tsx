...
export function AdminComplaintsClient({
  ...
  const avgResolutionHrs = (() => {
    const resolvedOnes = complaints.filter(
  ...
  const handleAction = async (complaintId: string, status: string) => {
    startTransition(async () => {
      const result = await updateComplaintStatus(
        ...
        status === "resolved"
          ? responseText || "Issue resolved by admin."
          : undefined,
      );
      if (result.error) {
        toast({
      ...
      {filtered.length === 0 ? (
        ...
        <div className="space-y-3">
          {filtered.map((complaint) => {
            ...
            const borderColor =
              PRIORITY_COLORS[complaint.priority] || "border-l-gray-300";
              ...
              >
                <CardContent className="py-4">
                  ...
                  <div
                    ...
                    onClick={() => setActiveId(isActive ? null : complaint.id)}
                  >
                    <div className="flex items-start gap-3 flex-1 min-w-0">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <Badge
                            variant="secondary"
                            className={`text-[10px] border-none ${st.color}`}
                          >
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            {complaint.status === "submitted" && (
                              <Button
                                ...
                                disabled={isPending}
                                onClick={() =>
                                  handleAction(complaint.id, "under_review")
                                }
                              >
                            ...
                            {["submitted", "under_review"].includes(
                              ...
                              <Button
                                ...
                                disabled={isPending}
                                onClick={() =>
                                  handleAction(complaint.id, "in_progress")
                                }
                              >
                            ...
                            <Button
                              ...
                              disabled={isPending}
                              onClick={() =>
                                handleAction(complaint.id, "rejected")
                              }
                            >
