...
} from "@/components/admin/recalculate-button";
...
export default async function IntelligenceDashboardPage() {
  ...
  const [
    ...
    admin
      .from("waste_reports")
      .select(
        "created_at, status, completed_at, predicted_class, confirmed_class",
      )
      .gte(
        "created_at",
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Risk scoring, geospatial analysis, and government benchmark
            comparison
          </p>
        </div>
