    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight">Challenges Management</h2>
            ...
            <div className="grid gap-4 md:grid-cols-4">
                <Card>
                    <CardHeader className="pb-2">
                        ...
                        <CardTitle className="text-2xl">{challenges?.length || 0}</CardTitle>
                    </CardHeader>
                </Card>
                <Card>
                    <CardHeader className="pb-2">
                                ...
                                <TableRow key={challenge.id}>
                                    ...
                                    <TableCell>
                                        <div className="flex items-center gap-1">
                                            ...
                                            {(challenge.challenge_participants as any)?.[0]?.count || 0}
                                        </div>
                                    </TableCell>
                                    <TableCell className="text-xs">
                                        <div>{formatDate(challenge.starts_at)}</div>
                                        <div className="text-muted-foreground">to {formatDate(challenge.ends_at)}</div>
                                    </TableCell>
                                    <TableCell>
