...
import { Award, Star, Users, Zap, Trophy, Target, Flame, Shield, Crown, Medal } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">View and manage achievement badges</p>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-4">
                ...
                <Card>
                    <CardHeader className="pb-2">
                        ...
                        <CardTitle className="text-2xl">{badgeAwards?.length || 0}</CardTitle>
                    </CardHeader>
                </Card>
                <Card>
                    <CardHeader className="pb-2">
                            ...
                            <CardHeader className="pb-2">
                                <div className="flex items-start justify-between">
                                    ...
                                    <Badge variant="outline" className="text-xs">
                                        {badge.tier === 5 ? 'Legendary' : badge.tier === 4 ? 'Epic' : badge.tier === 3 ? 'Rare' : badge.tier === 2 ? 'Uncommon' : 'Common'}
                                    </Badge>
                                </div>
                            </CardHeader>
                            <CardContent>
                        ...
                        <TableBody>
                            {badges?.map((badge) => (
                                <TableRow key={badge.id}>
                                    ...
                                    <TableCell className="capitalize">{(badge.requirements as any)?.type || 'Achievement'}</TableCell>
                                    <TableCell>
                                        <Badge
                                            variant="outline"
                                            className={
                                                badge.tier === 5 ? 'border-purple-500 text-purple-600' :
                                                    badge.tier === 4 ? 'border-blue-500 text-blue-600' :
                                                        badge.tier >= 3 ? 'border-green-500 text-green-600' :
