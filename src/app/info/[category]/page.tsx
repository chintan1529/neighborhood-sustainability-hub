...
> = {
  plastic: {
    ...
    description:
      "Recyclable plastic items like bottles, containers, and packaging",
    longDescription:
      "Plastic waste includes items made from polymers that can often be recycled into new products. Proper plastic recycling reduces landfill waste, conserves petroleum resources, and decreases pollution.",
    examples: [
      "Water bottles (PET #1)",
      "Milk jugs (HDPE #2)",
      "Shampoo bottles",
    ...
    recyclingProcess: [
      {
        step: "Collection",
        description: "Plastics are collected and sorted by resin type",
      },
      {
        step: "Processing",
        description: "Cleaned and shredded into tiny flakes",
      },
    ...
    funFact:
      "A recycled plastic bottle can become part of a fleece jacket, playground equipment, or even a new bottle!",
  },
  glass: {
    name: "Glass",
    icon: Wine,
    ...
    longDescription:
      "Glass is 100% recyclable and can be recycled endlessly without loss of quality. Recycling glass reduces energy consumption and raw material extraction.",
    examples: [
      "Wine bottles",
      "Beer bottles",
      "Food jars",
    ...
    recyclingProcess: [
      ...
      {
        step: "Purification",
        description: "Contaminants removed through cleaning",
      },
      {
        step: "Rebirth",
        description: "Melted and molded into new glass products",
      },
    ],
    environmentalImpact: [
    ...
    funFact:
      "Glass takes over 1 million years to decompose in a landfill, but can be recycled infinite times!",
  },
  metal: {
    name: "Metal",
    icon: Wrench,
    ...
    longDescription:
      "Metals like aluminum and steel are highly recyclable and valuable. Aluminum can be recycled indefinitely, and recycling it uses 95% less energy than producing new aluminum.",
    examples: [
      "Aluminum soda cans",
      "Beer cans",
      "Food cans",
    ...
    recyclingProcess: [
      {
        step: "Separation",
        description: "Magnets separate steel from aluminum",
      },
  ...
  paper: {
    ...
    longDescription:
      "Paper recycling saves trees, water, and energy. Paper can typically be recycled 5-7 times before the fibers become too short.",
    examples: [
      "Newspapers",
      "Magazines",
      "Office paper",
    ...
    recyclingProcess: [
      ...
      {
        step: "Cleaning",
        description: "Ink removed through de-inking process",
      },
    ...
    funFact:
      "The average American uses about 700 pounds of paper products per year!",
  },
  cardboard: {
    name: "Cardboard",
    icon: Package,
    ...
    longDescription:
      "Cardboard is one of the most commonly recycled materials. It can be recycled multiple times and is in high demand by manufacturers.",
    examples: [
      "Shipping boxes",
      "Cereal boxes",
      "Shoe boxes",
    ...
    notAllowed: [
      ...
      "Juice boxes (require special recycling)",
    ],
    recyclingProcess: [
    ...
    funFact:
      "Cardboard corrugated boxes are the most recycled packaging material in the world!",
  },
  organic: {
    name: "Organic",
    icon: Leaf,
    ...
    longDescription:
      "Organic waste can be composted to create nutrient-rich soil. Composting diverts waste from landfills and reduces methane emissions.",
    examples: [
    ...
    notAllowed: [
      "Plastic bags",
      "Meat and fish (in some programs)",
      "Dairy products",
      "Oils and fats",
      "Pet waste",
      "Diseased plants",
    ...
    recyclingProcess: [
      ...
      {
        step: "Decomposition",
        description: "Natural breakdown with heat and microbes",
      },
    ...
    funFact:
      "Composting for just 6 months can create enough soil to fill a garden bed!",
  },
  hazardous: {
    name: "Hazardous",
    icon: AlertTriangle,
    ...
    longDescription:
      "Hazardous waste contains chemicals that can harm human health and the environment. These items must be disposed of properly at designated facilities.",
    examples: [
      "Batteries (all types)",
    ...
    recyclingProcess: [
      {
        step: "Collection",
        description: "Specialized pickup at designated sites",
      },
      {
        step: "Classification",
        description: "Sorted by hazard type and risk level",
      },
      { step: "Treatment", description: "Neutralized or processed safely" },
      {
        step: "Recovery",
        description: "Materials recovered or safely disposed",
      },
    ],
    environmentalImpact: [
    ...
    funFact:
      "A single quart of motor oil can contaminate up to 250,000 gallons of drinking water!",
  },
  mixed: {
    name: "Mixed/General",
    icon: Trash2,
    ...
    longDescription:
      "Mixed waste includes items that cannot be recycled or composted. The goal is to minimize this category by choosing recyclable alternatives.",
    examples: [
      "Broken ceramics",
      "Dirty diapers",
      "Pet waste",
    ...
    recyclingProcess: [
      {
        step: "Collection",
        description: "Waste gathered from bins and collection points",
      },
      ...
      {
        step: "Disposal",
        description: "Remaining waste goes to managed landfill",
      },
    ],
    environmentalImpact: [
...
export default function CategoryPage() {
  ...
  const [activeTab, setActiveTab] = useState<"examples" | "notallowed">(
    "examples",
  );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-muted/20">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div
          className={`absolute top-20 left-10 w-72 h-72 bg-gradient-to-r ${category.gradient} rounded-full blur-[100px] opacity-20 animate-pulse`}
        />
        <div
          className={`absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-r ${category.gradient} rounded-full blur-[120px] opacity-15 animate-pulse`}
      ...
      <div className="relative container mx-auto py-8 px-4 max-w-5xl">
        ...
        {/* Hero Section */}
        <div
          className={`relative overflow-hidden rounded-3xl bg-gradient-to-r ${category.gradient} p-1 mb-10`}
        >
          ...
          <div className="relative bg-background/95 dark:bg-background/90 backdrop-blur-xl rounded-[22px] p-8 md:p-12">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-8">
              ...
              <div className={`relative group`}>
                <div
                  className={`absolute inset-0 bg-gradient-to-r ${category.gradient} rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity`}
                />
                <div
                  className={`relative w-20 h-20 md:w-24 md:h-24 rounded-2xl bg-gradient-to-r ${category.gradient} flex items-center justify-center shadow-2xl ${category.glowColor} transform transition-transform hover:scale-105`}
                >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  <h1
                    className={`text-4xl md:text-5xl font-bold bg-gradient-to-r ${category.gradient} bg-clip-text text-transparent`}
                  >
                    {category.name}
                  </h1>
                  <Sparkles
                    className={`h-6 w-6 ${category.accentColor} animate-pulse`}
                  />
                </div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-10">
          {category.environmentalImpact.map((impact, i) => (
            ...
            >
              ...
              />
              <div
                className={`text-3xl md:text-4xl font-bold bg-gradient-to-r ${category.gradient} bg-clip-text text-transparent mb-1`}
              >
                {impact.stat}
              </div>
        ...
        <div className="mb-10">
          ...
          >
            {(activeTab === "examples"
              ...
              <div
                key={i}
                className={`group relative overflow-hidden rounded-xl border p-4 transition-all hover:scale-105 hover:shadow-lg ${
                  activeTab === "examples"
        ...
        {/* Pro Tips */}
        <div
          className={`relative overflow-hidden rounded-2xl border border-yellow-200 dark:border-yellow-900/50 bg-gradient-to-br from-yellow-50 to-amber-50 dark:from-yellow-950/30 dark:to-amber-950/30 p-8 mb-10`}
        >
        ...
        <div className="mb-10">
          ...
          <div className="relative">
            {/* Timeline line */}
            <div
              className={`absolute left-6 top-0 bottom-0 w-1 bg-gradient-to-b ${category.gradient} rounded-full opacity-30`}
            />
            ...
            <div className="space-y-4">
              {category.recyclingProcess.map((process, i) => (
                <div
                  key={i}
                  className={`relative flex items-start gap-6 pl-2 transition-all duration-300 ${
                    hoveredStep === i ? "scale-[1.02]" : ""
                  }`}
                ...
                >
                  {/* Step number */}
                  <div
                    className={`relative z-10 w-10 h-10 rounded-xl flex items-center justify-center text-white font-bold shadow-lg transition-all ${
                      hoveredStep === i
        ...
        {/* Fun Fact */}
        <div
          className={`relative overflow-hidden rounded-2xl bg-gradient-to-r ${category.gradient} p-1 mb-10`}
        >
          <div className="bg-background/95 dark:bg-background/90 backdrop-blur-xl rounded-[14px] p-8">
            <div className="flex items-start gap-4">
              <div
                className={`flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-r ${category.gradient} flex items-center justify-center`}
              >
                <Sparkles className="h-6 w-6 text-white" />
              </div>
              <div>
                <h3
                  className={`font-bold text-lg mb-2 bg-gradient-to-r ${category.gradient} bg-clip-text text-transparent`}
                >
                  Did You Know?
                </h3>
        ...
        <div className="text-center py-10">
          <h2 className="text-2xl font-bold mb-4">
            Ready to Report {category.name} Waste?
          </h2>
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
            Help keep your neighborhood clean by reporting{" "}
            {category.name.toLowerCase()} waste that needs collection.
          </p>
