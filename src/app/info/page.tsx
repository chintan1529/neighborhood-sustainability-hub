...
const IMPACT_STATS = [
  {
    icon: TreePine,
    value: "17",
    label: "Trees saved per ton of paper",
  ...
  },
  {
    icon: Zap,
    value: "95%",
    label: "Energy saved recycling aluminum",
    gradient: "from-yellow-500 to-orange-500",
  },
  {
    icon: Globe,
    value: "♾️",
    label: "Glass can be recycled infinitely",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-muted/20">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-60 right-20 w-96 h-96 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full blur-[120px] opacity-15 animate-pulse"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="absolute bottom-40 left-1/3 w-80 h-80 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full blur-[100px] opacity-10 animate-pulse"
      ...
      <div className="relative container mx-auto py-8 px-4 max-w-6xl">
        ...
        <div className="text-center mb-16 pt-8">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Master the art of recycling. Learn how to properly sort and dispose
            of your waste to protect our planet for future generations.
          </p>
        </div>
        ...
        <div className="relative max-w-2xl mx-auto mb-16">
          ...
          >
            <div
              className={`absolute inset-0 bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 rounded-2xl blur-xl opacity-30 transition-opacity ${
                isSearchFocused ? "opacity-50" : "opacity-30"
              }`}
            />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
          {IMPACT_STATS.map((stat, i) => (
            ...
            >
              <div
                className={`absolute inset-0 bg-gradient-to-r ${stat.gradient} opacity-0 group-hover:opacity-10 transition-opacity`}
              />
              <div
              ...
              <div
                className={`text-2xl md:text-3xl font-bold bg-gradient-to-r ${stat.gradient} bg-clip-text text-transparent mb-1`}
              >
                {stat.value}
              </div>
            ...
            return (
              ...
              >
                ...
                >
                  {/* Gradient Border */}
                  <div
                    className={`absolute inset-0 bg-gradient-to-r ${category.gradient} rounded-2xl p-[1px] opacity-50 group-hover:opacity-100 transition-opacity`}
                  >
                    <div className="absolute inset-[1px] bg-background rounded-[15px]" />
                  </div>

                  <div
                    className={`relative h-full ${category.lightBg} rounded-2xl p-6 transition-colors`}
                  >
                    {/* Icon */}
                    <div className="relative mb-4">
                      <div
                        className={`absolute inset-0 bg-gradient-to-r ${category.gradient} rounded-xl blur-lg opacity-40 group-hover:opacity-60 transition-opacity`}
                      />
                      <div
                        className={`relative w-14 h-14 rounded-xl bg-gradient-to-r ${category.gradient} flex items-center justify-center shadow-lg transition-transform group-hover:scale-110`}
                      >
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-border/50">
                      ...
                      <ChevronRight
                        className={`h-5 w-5 text-muted-foreground transition-transform ${isHovered ? "translate-x-1" : ""}`}
                      />
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-background/95 dark:bg-background/90 backdrop-blur-xl rounded-[22px] p-8 md:p-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[
                {
                  icon: "🧴",
                  tip: "Always rinse containers before recycling to prevent contamination",
                },
                {
                  icon: "📦",
                  tip: "Flatten cardboard to save space and make collection easier",
                },
                {
                  icon: "♻️",
                  tip: "Check for recycling symbols on plastic items (numbers 1-7)",
                },
                {
                  icon: "📸",
                  tip: "When in doubt, take a photo and use our AI classification!",
                },
              ].map((item, i) => (
                <div
                  key={i}
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-primary via-primary/90 to-primary/80 p-12 text-center text-primary-foreground">
          ...
          <div className="relative">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Ready to Report Waste?
            </h2>
            <p className="text-lg opacity-90 mb-8 max-w-xl mx-auto">
              Found waste that needs to be collected? Report it now and help
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/resident/report/new">
                <Button
                  size="lg"
                  variant="secondary"
                  className="group px-8 shadow-xl"
                >
              ...
              <Link href="/resident/classify">
                <Button
                  size="lg"
                  variant="outline"
                  className="px-8 bg-white/10 border-white/30 hover:bg-white/20"
                >
