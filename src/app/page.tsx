...
import { ArrowRight, Leaf, MapPin, Trophy, Recycle, Users, BarChart3, Camera, Shield, Sparkles, CheckCircle2 } from 'lucide-react';
                ...
                <div className="container mx-auto px-4 relative">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="animate-slide-up delay-1 text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
                            Report waste in 15 seconds, earn rewards, and track your community&apos;s
                            environmental impact. AI-powered classification meets hyperlocal action.
                        </p>
                    ...
                    <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-4xl mx-auto">
                        {[
                            { value: '10K+', label: 'Reports Filed', accent: 'border-l-emerald-500' },
                            { value: '95%', label: 'SLA Compliance', accent: 'border-l-blue-500' },
                            { value: '500+', label: 'Active Users', accent: 'border-l-amber-500' },
                            { value: '24h', label: 'Avg Resolution', accent: 'border-l-purple-500' },
                        ].map((stat, i) => (
                            <div
                                key={stat.label}
                ...
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            From AI-powered classification to real-time tracking, we&apos;ve got you covered.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Pin exact locations on the map for precise waste identification and faster resolution.',
                                color: 'text-blue-600 bg-blue-50 dark:bg-blue-950/40',
                            },
                            {
                                icon: Camera,
                                title: 'AI Classification',
                                description: 'Automatic waste categorization using AI. 7 categories: Plastic, Paper, Metal, Glass, Cardboard, Organic, Mixed.',
                                color: 'text-emerald-600 bg-emerald-50 dark:bg-emerald-950/40',
                            },
                            {
                                icon: Trophy,
                                title: 'Gamification & Rewards',
                                description: 'Earn points, unlock badges, climb leaderboards, and participate in community challenges.',
                                color: 'text-amber-600 bg-amber-50 dark:bg-amber-950/40',
                            },
                            {
                                icon: Users,
                                title: 'Community Driven',
                                description: 'Connect with your neighborhood, compete on leaderboards, and celebrate collective impact.',
                                color: 'text-purple-600 bg-purple-50 dark:bg-purple-950/40',
                            },
                            {
                                icon: BarChart3,
                                title: 'Admin Dashboard',
                                description: 'Real-time analytics, SLA monitoring, and one-click municipal compliance reports.',
                                color: 'text-red-600 bg-red-50 dark:bg-red-950/40',
                            },
                            {
                                icon: Shield,
                                title: 'SDG Aligned',
                                description: 'Track your contribution to UN Sustainable Development Goals 11.6 and 12.5.',
                            ...
                            return (
                                ...
                                >
                                    <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl ${feature.color} mb-5 transition-transform group-hover:scale-110`}>
                        ...
                        {[
                            {
                                step: '01',
                                title: 'Snap a Photo',
                                description: 'Open the app, snap a photo of the waste. Our AI automatically classifies it.',
                                icon: Camera,
                            },
                            {
                                step: '02',
                                title: 'Pin Location',
                                description: 'Confirm the location on the map or let GPS do it automatically.',
                                icon: MapPin,
                            },
                            {
                                step: '03',
                                title: 'Track & Earn',
                                description: 'Submit and track progress. Earn points when collection is complete!',
                                icon: Trophy,
                            },
                        ].map((item) => {
            ...
            <section id="impact" className="py-24 bg-foreground text-background">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-14">
                        <p className="text-sm font-semibold text-primary tracking-widest uppercase mb-3">Impact</p>
                        <h2 className="text-3xl md:text-5xl font-bold mb-4 tracking-tight">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                        <div className="border border-background/10 rounded-2xl p-8 hover:bg-background/5 transition-colors">
                            ...
                            <h3 className="text-2xl font-bold mb-3 tracking-tight">Sustainable Cities</h3>
                            <p className="text-background/65 leading-relaxed">
                                Reduce the adverse per capita environmental impact of cities by paying special
                                attention to municipal waste management.
                            </p>
                            <div className="mt-6 flex items-center gap-4 text-sm text-background/50">
                                <div className="flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4 text-primary" /> Waste tracking</div>
                                <div className="flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4 text-primary" /> Urban cleanup</div>
                            </div>
                        </div>
                        <div className="border border-background/10 rounded-2xl p-8 hover:bg-background/5 transition-colors">
                            <div className="inline-flex items-center gap-2 bg-background/10 px-3 py-1.5 rounded-full text-sm font-medium mb-5">
                            ...
                            <h3 className="text-2xl font-bold mb-3 tracking-tight">Responsible Consumption</h3>
                            <p className="text-background/65 leading-relaxed">
                                Substantially reduce waste generation through prevention, reduction, recycling,
                                and reuse.
                            </p>
                            <div className="mt-6 flex items-center gap-4 text-sm text-background/50">
                                <div className="flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4 text-primary" /> AI sorting</div>
                                <div className="flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4 text-primary" /> Recycling guides</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-4 text-center">
                    <div className="max-w-2xl mx-auto">
                        ...
                        <p className="text-lg text-muted-foreground mb-10 max-w-xl mx-auto leading-relaxed">
                            Join thousands of residents building cleaner, more sustainable neighborhoods.
                        </p>
                        <Link
                            href="/auth/signup"
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-2.5">
                            ...
                            <span className="font-semibold text-sm">Neighborhood Sustainability Hub</span>
                        </div>
                        <p className="text-sm text-muted-foreground">
                            © {new Date().getFullYear()} NHS. Built for sustainable communities.
                        </p>
                    </div>
                </div>
            </footer>
