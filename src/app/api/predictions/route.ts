...
import { generatePredictions, getPredictionGeoJson, getPredictionSummary } from '@/lib/predictive-engine';
...
export async function POST() {
    try {
        ...
        const { data: profile } = await supabase
            ...
            .eq('id', user.id)
            .single();
        const typedProfile = profile as { role?: string; neighborhood_id?: string | null } | null;
