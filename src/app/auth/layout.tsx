                ...
                <div className="relative z-20 mt-auto space-y-10">
                    ...
                    <blockquote className="border-l-2 border-primary pl-4">
                        <p className="text-sm text-background/70 leading-relaxed italic">
                            &ldquo;This platform has completely transformed how our neighborhood manages waste.
                            The AI classification is like magic, and earning rewards makes it fun!&rdquo;
                        </p>
                        <footer className="text-xs text-background/40 mt-2">— Community Member</footer>
                    </blockquote>
                </div>
            </div>
