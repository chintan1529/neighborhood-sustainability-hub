...
import { MapPin, Clock, Package, ArrowLeft, CheckCircle, XCircle, Play } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">Job ID: {job.id.slice(0, 8)}...</p>
                </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Information about this waste pickup</CardDescription>
                    </CardHeader>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        {(job.status === 'assigned' || job.status === 'in_progress') && (
                            <form action={async () => {
                                ...
                                <Button variant="outline" className="w-full text-red-600 border-red-200 hover:bg-red-50" size="lg">
                        ...
                        {job.status === 'completed' && (
                            <div className="text-center py-4">
                                ...
                                <p className="font-medium text-green-600">This job has been completed</p>
                                {job.completed_at && (
                                    <p className="text-sm text-muted-foreground">
