  ...
  return (
    <div className="container max-w-3xl py-12 animate-in fade-in zoom-in-95 duration-500">
      <div className="mb-8 text-center">
        <div className="mx-auto w-16 h-16 bg-teal-100 dark:bg-teal-900/40 text-teal-600 dark:text-teal-400 rounded-full flex items-center justify-center mb-4">
        ...
        <div className="flex gap-2 mt-8 max-w-sm mx-auto">
          {[1, 2].map((s) => (
            <div
              key={s}
              className={`h-2 rounded-full flex-1 transition-colors duration-300 ${s <= step ? "bg-teal-600" : "bg-muted"}`}
            />
          ))}
        </div>
      </div>
      ...
      <Card className="shadow-xl border-muted/50">
                    ...
                    <div
                      ...
                      className={`flex items-center space-x-3 border p-3 rounded-lg cursor-pointer transition-colors ${
                        formData.accepted_categories?.includes(cat.id)
                          ? "bg-teal-50/50 border-teal-200 dark:bg-teal-950/20 dark:border-teal-900"
                          : "hover:bg-muted/50"
                      }`}
        ...
        {step === 2 && (
          <>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <MapPin className="w-5 h-5 text-teal-600" /> Operating Location
              </CardTitle>
              <CardDescription>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4 pt-4 border-t">
                ...
                <div className="p-3 bg-teal-50 dark:bg-teal-950/30 text-teal-700 dark:text-teal-400 rounded-lg flex items-start gap-2 border border-teal-100 dark:border-teal-900 mb-2">
                ...
                <div className="rounded-xl overflow-hidden border-2 border-border focus-within:border-teal-500 transition-colors shadow-sm relative">
                  <MapLoader
                    interactive={true}
        ...
        <CardFooter className="bg-muted/20 border-t p-6 flex justify-between">
          ...
          {step === 1 ? (
            ...
            <Button
              ...
              className="bg-teal-600 hover:bg-teal-700 text-white min-w-[140px] shadow-lg shadow-teal-500/20"
            >
              {isSubmitting ? (
                <>
