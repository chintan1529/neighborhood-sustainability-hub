      ...
      <Card className="text-center py-16">
        <CardContent>
          ...
          <p className="text-muted-foreground mb-4">
            Click &quot;New Chat&quot; to start a conversation with a resident
            or admin.
          </p>
        </CardContent>
      </Card>
    ...
    <div className="space-y-2">
      {conversations.map((conv) => {
        ...
        return (
          <Link
            key={conv.id}
            href={`/recycler/messages/${conv.id}`}
            className="block"
          >
            <Card
...
export default function RecyclerMessagesPage() {
  return (
    <div className="container mx-auto py-8 px-4 max-w-3xl">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Chat with residents and admins about marketplace listings.
          </p>
        </div>
        <NewConversationDialog basePath="/recycler/messages" />
      </div>
