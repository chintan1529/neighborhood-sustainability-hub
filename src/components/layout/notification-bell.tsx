...
import { Bell, Check, Trash2, ExternalLink, AlertCircle, Award, Trophy, MessageSquare, Calendar, FileText } from 'lucide-react';
        ...
        <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="relative">
                    ...
                    {unreadCount > 0 && (
                        <Badge
                            className="absolute -top-1 -right-1 h-5 min-w-5 px-1 flex items-center justify-center bg-red-500 text-white text-xs"
                        >
            ...
            <DropdownMenuContent align="end" className="w-80">
                    ...
                    {isLoading ? (
                        ...
                        notifications.map((notification) => {
                            ...
                            return (
                                <div
                                    key={notification.id}
                                    className={`p-3 border-b last:border-b-0 hover:bg-muted/50 transition-colors ${!notification.is_read ? 'bg-primary/5' : ''
                                        }`}
                                >
                ...
                <DropdownMenuItem asChild>
                    <Link href="/resident/notifications" className="flex items-center justify-center">
