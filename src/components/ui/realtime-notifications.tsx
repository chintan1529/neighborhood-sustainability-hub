                    ...
                    if (oldStatus !== newStatus) {
                        ...
                        if (newStatus === 'assigned') {
                            toast('Collector Dispatched! 🚛', {
                                description: 'A collector has claimed your waste report and is on their way.',
                                duration: 5000,
                                icon: <Truck className="h-5 w-5 text-blue-500" />,
                            });
                        } else if (newStatus === 'completed') {
                            toast.success('Pickup Completed! ✨', {
                                description: 'Your waste has been collected. You can now leave a review!',
                                duration: 6000,
                                icon: <CheckCircle className="h-5 w-5 text-emerald-500" />,
                            });
                        } else if (newStatus === 'verified') {
                            toast('Verification Complete ✅', {
                                description: 'Your latest report has been officially verified by the admin.',
                                duration: 5000,
                            });
                        }
                    }
