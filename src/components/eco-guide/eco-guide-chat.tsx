            ...
            {QUICK_SUGGESTIONS.map((suggestion) => {
              ...
              return (
                <button
                  ...
                  disabled={isLoading}
                  className="flex items-center gap-2 px-3 py-2 rounded-lg border border-border bg-card text-xs font-medium hover:bg-muted transition-colors duration-150 disabled:opacity-50"
                >
