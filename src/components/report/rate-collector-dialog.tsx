...
export function RateCollectorDialog({
  reportId,
  trigger,
}: RateCollectorDialogProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            How did the waste collector perform on this pickup? Your feedback
            helps us maintain high quality service.
          </DialogDescription>
        </DialogHeader>
