                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            >
                              ...
                              <SelectContent>
                                {Object.entries(WASTE_CATEGORIES).map(
                                  ([key, value]) => (
              ...
              {step === 2 && (
                <div className="space-y-4">
                  ...
                  <div className="relative h-[400px] w-full border rounded-md overflow-hidden bg-muted">
                    <Map
                      center={[
                        form.watch("latitude") || 12.9716,
                        form.watch("longitude") || 77.5946,
                      ]}
                  ...
                  <p className="text-xs text-muted-foreground text-center">
                    Tap map to refine pin location
                  </p>
                </div>
              )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="e.g. Near Gate 1, Block B"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                  ...
                  <div className="rounded-lg border p-4 space-y-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {form.getValues("address") || "Pinned Location"}
                        </p>
                      </div>
                    </div>
