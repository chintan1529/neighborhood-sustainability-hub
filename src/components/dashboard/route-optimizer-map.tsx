...
export default function RouteOptimizerMap({ reports, defaultCenter }: Props) {
  ...
  const polylineCoords: [number, number][] = route
    ? [
        ...
        ...route.stops.map(
          (s) => [s.report.latitude, s.report.longitude] as [number, number],
        ),
      ]
    : [];
              ...
              {route ? (
                <>
                  ...
                  {route.stops.map((stop) => {
                    ...
                    const cat =
                      WASTE_CATEGORIES[
                        wasteType as keyof typeof WASTE_CATEGORIES
                      ];
                    ...
                    return (
                      <div
                        ...
                        onClick={() =>
                          setSelectedStop(
                            stop.index === selectedStop ? null : stop.index,
                          )
                        }
                      >
