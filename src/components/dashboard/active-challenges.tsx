    ...
    return (
        <Card className="col-span-1 shadow-subtle hover:shadow-soft transition-all duration-300 overflow-hidden border border-border/60 relative">
            ...
            <CardHeader className="flex flex-row items-center justify-between pb-4">
                ...
                <Button asChild variant="ghost" size="sm" className="text-xs hover:bg-amber-50 dark:hover:bg-amber-950/30 hover:text-amber-600">
                ...
                <div className="space-y-4">
                    {challenges.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-10 text-center">
                            ...
                            <p className="font-medium text-sm text-muted-foreground mb-1">No active challenges</p>
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="flex justify-between text-[11px]">
                                            <span className="text-muted-foreground font-medium">
                                                ...
                                                <span className="text-muted-foreground/60"> / {challenge.target_count} items</span>
                                            </span>
                                            <span className={`font-semibold ${isCompleted ? 'text-emerald-600' : 'text-muted-foreground'}`}>
                                                {Math.round(progress)}%
                                            </span>
                                        </div>
                                    </div>
