      ...
      <CardContent className="relative pt-5 pb-5 px-5">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-semibold text-sm flex items-center gap-2">
                ...
                <Badge
                  variant="outline"
                  className="text-[9px] px-1.5 py-0 border-violet-300 text-violet-600 dark:text-violet-400 dark:border-violet-700"
                >
                  AI Insight
                </Badge>
              </h3>
        ...
        <div className="space-y-2">
          {insight.tips.map((tip, i) => (
            <div
              key={i}
              className="flex items-start gap-2.5 p-2 rounded-lg hover:bg-background/60 transition-colors"
            >
